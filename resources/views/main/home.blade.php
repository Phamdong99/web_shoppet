            ...
            @foreach($categories as $key => $category)
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        <img src="{{ $category->file }}" alt="IMG-BANNER" height="350px">

                        <a href="/danh-muc/{{$category->id}}-{{\Illuminate\Support\Str::slug($category->name)}}.html" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
